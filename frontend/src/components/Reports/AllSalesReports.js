                ...
                {reports.length > 0 ? (
                    <>
                        ...
                        <div className="all-sales-respor-pagination">
                            <button className="all-sales-respor-pagination-btn"
                            onClick={handlePreviousPage} disabled={currentPage === 1}>
                                السابق
                            </button>
                            <span className="all-sales-respor-pagination-info">صفحة {currentPage} من {totalPages}</span>
                            <button className="all-sales-respor-pagination-btn"
