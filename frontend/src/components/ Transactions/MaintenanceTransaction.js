...
const MaintenanceTransaction = () => {
  ...
  const fetchTransactions = useCallback(
    async (page) => {
      ...
      try {
        const response = await axios.get('https://tarek-store-backend.onrender.com/api/transactions/daymaintenance', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://tarek-store-backend.onrender.com/api/transactions/maintenance', {
        branchId,
        user: userId,
        type,
        description,
